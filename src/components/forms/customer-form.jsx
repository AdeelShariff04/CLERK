                ...
                <div className="card-body">
                    ...
                    <div className="row">
                        <div className="col-lg-6">
                            <Input icon="feather-user" label="Customer Name" labelId="customerName" placeholder="Alexandra Della" name="customerName" />
                            <Input icon="feather-activity" label="Customer ID" labelId="customerId" placeholder="CUS-001" name="customerId" />
                        ...
                        <div className="col-lg-6">
                            <Input icon="feather-phone" label="Phone" labelId="customerPhone" placeholder="+1 (202) 555-0147" name="phone" />
                            <Input icon="feather-mail" label="Email" labelId="customerEmail" placeholder="customer@email.com" name="email" type="email" />
                            <Input icon="feather-map-pin" label="Address" labelId="customerAddress" placeholder="Customer address" name="address" />
                            <div className="row mb-4 align-items-center">
