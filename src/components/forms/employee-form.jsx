                ...
                <div className="card-body">
                    ...
                    <div className="row">
                        <div className="col-lg-6">
                            <Input icon="feather-user" label="Employee Name" labelId="employeeName" placeholder="Janette Dalton" name="employeeName" />
                            <Input icon="feather-activity" label="Employee ID" labelId="employeeId" placeholder="EMP-001" name="employeeId" />
                            ...
                            <Input icon="feather-phone" label="Phone" labelId="employeePhone" placeholder="+1 (202) 555-0147" name="phone" />
                            <Input icon="feather-phone-call" label="Emergency Contact" labelId="emergencyContact" placeholder="Emergency contact number" name="emergencyContact" />
                        </div>
                        <div className="col-lg-6">
                            <Input icon="feather-mail" label="Email" labelId="employeeEmail" placeholder="employee@email.com" name="email" type="email" />
                            <Input icon="feather-credit-card" label="CNIC" labelId="employeeCnic" placeholder="CNIC number" name="cnic" />
                            <Input icon="feather-map-pin" label="Address" labelId="employeeAddress" placeholder="Employee address" name="address" />
                            <div className="row mb-4 align-items-center">
                            ...
                            <Input icon="feather-briefcase" label="Designation" labelId="designation" placeholder="Sales Manager" name="designation" />
                            <Input icon="feather-dollar-sign" label="Salary" labelId="salary" placeholder="5000.00" name="salary" type="number" />
                            <div className="row mb-4 align-items-center">
